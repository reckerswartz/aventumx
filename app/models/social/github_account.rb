...
# Indexes
#
#  index_github_accounts_on_discarded_at  (discarded_at)
#  index_github_accounts_on_user_id       (user_id)
#  index_github_accounts_on_uuid_secure   (uuid_secure) UNIQUE
#  index_github_accounts_on_uuid_token    (uuid_token) UNIQUE
#
# Foreign Keys
#
#  fk_rails_...  (user_id => users.id)
#
class Social::GithubAccount < ApplicationRecord
  ##############################################################################
